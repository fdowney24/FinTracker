...
import { COLORS, SIZES, todayString } from '../theme';

// SQL concept taught: INSERT with parameterised values
...
export default function AddTransactionScreen({ navigation }) {
  ...
  const [categoryId, setCategoryId] = useState('2'); // default: Food & Drink
  const [date, setDate] = useState(todayString());   // YYYY-MM-DD
